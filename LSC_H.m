function [ label_Result1] = LSC_H(data,numberOfModel,inlierScale,AA,model_type)
...
[II_3, EE_3]=entropy_thresholding(weight_3);
...
for i=1:numberOfModel
    ...
    idinliers2=rold<newScales*2.5*a;
    idinliers=rold<newScales*2.5*1;
